module github.com/smnsjas/packer-psrp-communicator
...
replace github.com/smnsjas/go-psrp => ../go-psrp-local

replace github.com/smnsjas/go-psrpcore => ../../go-psrpcore-local
